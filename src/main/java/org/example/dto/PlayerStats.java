...
@JsonPropertyOrder({"userId", "sport", "totalGames", "totalPoints", "averagePoints", "totalWins", "totalDraws", "totalLosses", "assists", "fouls", "yellowCards", "redCards", "setsWon", "submissions", "knockdowns", "timePlayed"})
